...
namespace mangle {
    ...
    inline std::string meth(const std::string& class_name, const std::string& method_name) {
        return class_name + "__" + method_name;
    }

    /// @brief Formats to `class_name___new`.
    inline std::string ctor(const std::string& class_name) {
        return class_name + "___new";
    }

    /// @brief Formats to `class_name___init`.
    inline std::string init(const std::string& class_name) {
        return class_name + "___init";
    }

    /// @brief Formats to `class_name___vtable`.
    inline std::string vt_global(const std::string& class_name) {
        return class_name + "___vtable";
    }

    /// @brief Formats to `class_name___VTable`.
    inline std::string vt_struct(const std::string& class_name) {
        return class_name + "___VTable";
    }
