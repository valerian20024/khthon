...
61:                                               ; preds = %53, %58
  %62 = load %_IO_FILE*, %_IO_FILE** @stderr
  %63 = call i32 (%_IO_FILE*, i8*, ...) @fprintf(%_IO_FILE* %62, i8* getelementptr inbounds ([58 x i8], [58 x i8]* @.str.8, i64 0, i64 0), i8* %3)
  call void @free(i8* %3)
  call void @exit(i32 1)
  unreachable

64:                                               ; preds = %53
  %65 = icmp slt i64 %.0, -2147483648
  br i1 %65, label %68, label %66

66:                                               ; preds = %64
  %67 = icmp sgt i64 %.0, 2147483647
  br i1 %67, label %68, label %71

68:                                               ; preds = %64, %66
  %69 = load %_IO_FILE*, %_IO_FILE** @stderr
  %70 = call i32 (%_IO_FILE*, i8*, ...) @fprintf(%_IO_FILE* %69, i8* getelementptr inbounds ([57 x i8], [57 x i8]* @.str.9, i64 0, i64 0), i8* %3)
  call void @free(i8* %3)
  call void @exit(i32 1)
  unreachable
